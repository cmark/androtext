...
public class ActivityImpl extends AndroidApplicationModelElementImpl implements Activity
{
  ...
  {
    return AndroTextDslPackage.Literals.ACTIVITY;
  }
  ...
  public RootLayout getLayout()
  {
    if (layout != null && layout.eIsProxy())
    {
      ...
      layout = (RootLayout)eResolveProxy(oldLayout);
      if (layout != oldLayout)
      {
   ...
   * @generated
   */
  public RootLayout basicGetLayout()
  {
    return layout;
  }
   ...
   * @generated
   */
  public void setLayout(RootLayout newLayout)
  {
    RootLayout oldLayout = layout;
    layout = newLayout;
    if (eNotificationRequired())
