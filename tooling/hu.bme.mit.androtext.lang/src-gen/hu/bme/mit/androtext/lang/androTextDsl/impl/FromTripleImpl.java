...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>From Triple</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link hu.bme.mit.androtext.lang.androTextDsl.impl.FromTripleImpl#getFirst <em>First</em>}</li>
 *   <li>{@link hu.bme.mit.androtext.lang.androTextDsl.impl.FromTripleImpl#getSecond <em>Second</em>}</li>
 *   <li>{@link hu.bme.mit.androtext.lang.androTextDsl.impl.FromTripleImpl#getThird <em>Third</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class FromTripleImpl extends MinimalEObjectImpl.Container implements FromTriple
{
  /**
  ...
  {
    return AndroTextDslPackage.eINSTANCE.getFromTriple();
  }
  ...
  public void setFirst(float newFirst)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AndroTextDslPackage.FROM_TRIPLE__FIRST, oldFirst, first));
  }
  ...
  public void setSecond(float newSecond)
  {
    ...
    second = newSecond;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AndroTextDslPackage.FROM_TRIPLE__SECOND, oldSecond, second));
  }
  ...
  public void setThird(float newThird)
  {
    ...
    third = newThird;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AndroTextDslPackage.FROM_TRIPLE__THIRD, oldThird, third));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AndroTextDslPackage.FROM_TRIPLE__FIRST:
        return getFirst();
      case AndroTextDslPackage.FROM_TRIPLE__SECOND:
        return getSecond();
      case AndroTextDslPackage.FROM_TRIPLE__THIRD:
        return getThird();
    }
