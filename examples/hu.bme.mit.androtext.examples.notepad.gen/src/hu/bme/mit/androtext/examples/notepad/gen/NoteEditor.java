 ...
 */
public class NoteEditor extends AbstractNoteEditor {
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            if (mState == STATE_EDIT) {
                ...
                String text = String.format("Edit: \"%1$s\"", title);
                setTitle(text);
            ...
            setTitle("Error");
            mText.setText("Error loading note");
        }
    }
    ...
    protected void onPause() {
        ...
        if (mState == STATE_INSERT && isFinishing() && (length == 0) && mCursor != null) {
