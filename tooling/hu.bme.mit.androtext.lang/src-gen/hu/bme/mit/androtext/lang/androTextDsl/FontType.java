 ...
 * <!-- end-user-doc -->
 * @see hu.bme.mit.androtext.lang.androTextDsl.AndroTextDslPackage#getFontType()
 * @model
 * @generated
 */
public enum FontType implements Enumerator
{
   ...
   * @ordered
   */
  BOLD_ITALIC(2, "BOLD_ITALIC", "BOLD_ITALIC");
   ...
   * @ordered
   */
  public static final int BOLD_ITALIC_VALUE = 2;
