 ...
 * <!-- end-user-doc -->
 * @see hu.bme.mit.androtext.lang.androTextDsl.AndroTextDslPackage#getSensorType()
 * @model
 * @generated
 */
public enum SensorType implements Enumerator
{
   ...
   * @ordered
   */
  ACCELEROMETER(0, "accelerometer", "accelerometer"),

  /**
   * The '<em><b>Orientation</b></em>' literal object.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see #ORIENTATION_VALUE
   * @generated
   * @ordered
   */
  ...
  /**
   * The '<em><b>Orientation</b></em>' literal value.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of '<em><b>Orientation</b></em>' literal object isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @see #ORIENTATION
   * @model name="orientation"
   * @generated
   * @ordered
   */
  public static final int ORIENTATION_VALUE = 1;
  ...
  public static SensorType get(int value)
  {
    switch (value)
    {
      ...
      case ORIENTATION_VALUE: return ORIENTATION;
    }
    return null;
  }
