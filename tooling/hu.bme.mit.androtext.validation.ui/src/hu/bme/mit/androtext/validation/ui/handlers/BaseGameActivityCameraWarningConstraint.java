...
import patternmatchers.androtext.BaseGameActivityCameraWarningMatcher;
import signatures.androtext.BaseGameActivityCameraWarningSignature;

/**
 * Constraint generated for baseGameActivityCameraWarning
 *
 */
public class BaseGameActivityCameraWarningConstraint extends Constraint<BaseGameActivityCameraWarningSignature> {
	
	@Override
	public IMatcherFactory<BaseGameActivityCameraWarningSignature, ? extends IncQueryMatcher<BaseGameActivityCameraWarningSignature>> matcherFactory() {
		return BaseGameActivityCameraWarningMatcher.FACTORY;
	}
	
	@Override
	public String getMessage(BaseGameActivityCameraWarningSignature signature) {
		String message = "BaseGameActivity $BGA$ not defines camera setting. Default is 720x480!";
	...
	@Override
	public EObject getLocationObject(BaseGameActivityCameraWarningSignature signature) {
