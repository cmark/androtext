 ...
 * <ul>
 *   <li>{@link hu.bme.mit.androtext.lang.androTextDsl.CheckBoxPreference#getName <em>Name</em>}</li>
...
public interface CheckBoxPreference extends AbstractPreference
{
   ...
   * @see #setName(String)
   * @see hu.bme.mit.androtext.lang.androTextDsl.AndroTextDslPackage#getCheckBoxPreference_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link hu.bme.mit.androtext.lang.androTextDsl.CheckBoxPreference#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
