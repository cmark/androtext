...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Gravity Kind</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see hu.bme.mit.androtext.lang.androTextDsl.AndroTextDslPackage#getGravityKind()
 * @model
 * @generated
 */
public enum GravityKind implements Enumerator
{
  /**
  ...
  /**
   * An array of all the '<em><b>Gravity Kind</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  private static final GravityKind[] VALUES_ARRAY =
    new GravityKind[]
    {
      TOP,
      BOTTOM,
  ...
  /**
   * A public read-only list of all the '<em><b>Gravity Kind</b></em>' enumerators.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static final List<GravityKind> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

  /**
   * Returns the '<em><b>Gravity Kind</b></em>' literal with the specified literal value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static GravityKind get(String literal)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      GravityKind result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Gravity Kind</b></em>' literal with the specified name.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static GravityKind getByName(String name)
  {
    for (int i = 0; i < VALUES_ARRAY.length; ++i)
    {
      GravityKind result = VALUES_ARRAY[i];
  ...
  /**
   * Returns the '<em><b>Gravity Kind</b></em>' literal with the specified integer value.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  public static GravityKind get(int value)
  {
    switch (value)
    {
   ...
   * @generated
   */
  private GravityKind(int value, String name, String literal)
  {
    this.value = value;
    this.name = name;
