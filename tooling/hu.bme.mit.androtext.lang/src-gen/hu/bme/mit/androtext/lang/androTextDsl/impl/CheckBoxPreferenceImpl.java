...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Check Box Preference</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class CheckBoxPreferenceImpl extends AbstractPreferenceImpl implements CheckBoxPreference
{
   ...
   * @generated
   */
  protected CheckBoxPreferenceImpl()
  {
    super();
  }
  ...
  public NotificationChain basicSetPreferenceAttributes(PreferenceAttributes newPreferenceAttributes, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, AndroTextDslPackage.CHECK_BOX_PREFERENCE__PREFERENCE_ATTRIBUTES, oldPreferenceAttributes, newPreferenceAttributes);
  ...
  public void setPreferenceAttributes(PreferenceAttributes newPreferenceAttributes)
  {
    if (newPreferenceAttributes != preferenceAttributes)
    {
      ...
      if (preferenceAttributes != null)
        msgs = ((InternalEObject)preferenceAttributes).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AndroTextDslPackage.CHECK_BOX_PREFERENCE__PREFERENCE_ATTRIBUTES, null, msgs);
      if (newPreferenceAttributes != null)
        msgs = ((InternalEObject)newPreferenceAttributes).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AndroTextDslPackage.CHECK_BOX_PREFERENCE__PREFERENCE_ATTRIBUTES, null, msgs);
      msgs = basicSetPreferenceAttributes(newPreferenceAttributes, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AndroTextDslPackage.CHECK_BOX_PREFERENCE__PREFERENCE_ATTRIBUTES, newPreferenceAttributes, newPreferenceAttributes));
  }
