 ...
 * <ul>
 *   <li>{@link hu.bme.mit.androtext.lang.androTextDsl.impl.RingtonePrefenceImpl#getName <em>Name</em>}</li>
...
public class RingtonePrefenceImpl extends AbstractPreferenceImpl implements RingtonePrefence
{
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, AndroTextDslPackage.RINGTONE_PREFENCE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case AndroTextDslPackage.RINGTONE_PREFENCE__NAME:
        return getName();
      case AndroTextDslPackage.RINGTONE_PREFENCE__PREFERENCE_ATTRIBUTES:
