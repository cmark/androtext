 ...
 * <ul>
 *   <li>{@link hu.bme.mit.androtext.lang.androTextDsl.AndroGuiModelRoot#getName <em>Name</em>}</li>
...
public interface AndroGuiModelRoot extends ModelRoot
{
   ...
   * @see #setName(String)
   * @see hu.bme.mit.androtext.lang.androTextDsl.AndroTextDslPackage#getAndroGuiModelRoot_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link hu.bme.mit.androtext.lang.androTextDsl.AndroGuiModelRoot#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
