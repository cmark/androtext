  ...
  public StringConcatenation body(final DatabaseContentProvider contentProvider, final TargetApplication application) {
    ...
    _builder.newLine();
    {
      ...
      for(final Entity e_9 : _entities_11) {
        ...
        String _columnsClassName_10 = this.generatorExtensions.columnsClassName(e_9);
        ...
        _builder.append(".AUTHORITY, ");
        String _columnsClassName_11 = this.generatorExtensions.columnsClassName(e_9);
      ...
      for(final Entity e_10 : _entities_12) {
        ...
        _builder.newLineIfNotEmpty();
        {
          ...
          for(final Property p_1 : _properties_1) {
            ...
            _builder.append(".put(");
            String _columnsClassName_14 = this.generatorExtensions.columnsClassName(e_10);
            _builder.append(_columnsClassName_14, "        ");
            _builder.append(".");
            String _name_5 = p_1.getName();
            String _upperCase_1 = _name_5.toUpperCase();
            _builder.append(_upperCase_1, "        ");
            _builder.append(", ");
            String _columnsClassName_15 = this.generatorExtensions.columnsClassName(e_10);
            _builder.append(_columnsClassName_15, "        ");
            _builder.append(".");
